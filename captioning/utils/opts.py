...
def parse_opt():
    ...
    # FastText arguments
    parser.add_argument('--use_ft', type=int, default=0, help='Whether or not to use FastText features inside the model')
    parser.add_argument('--ft_size', type=int, default=300, help='Dimension of word embedding model')
    parser.add_argument('--input_att_dir_ft', type=str, default='data/fasttext_att',
                    help='path to the directory containing the preprocessed att feats')
    parser.add_argument('--augmentation', type=str, default=None,
                        help='Which type of augmentation to use at text, options are: uniform, inv_multi, co_occurence')
    parser.add_argument('--obj_ids_dir', type=str, default='data/obj_ids', help='The path where we stored object names')
    parser.add_argument('--label_aligned', type=int, default=0, help='Concatenate the labels to features')
    parser.add_argument('--use_vc', type=int, default=0, help='whether or not to use visual commonsense features.')
    parser.add_argument('--input_att_dir_vc', type=str, default='data/vc_coco_trainval_2014')
    ...
    parser.add_argument('--num_workers', type=int, default=4, help='number of workers to use to fetch data')
    # Sample related
    ...
    if args.use_box and args.use_ft: args.ft_size = args.ft_size + 5
    elif args.use_box: args.att_feat_size = args.att_feat_size + 5
